...
<section class="flex items-center hero">
    ...
    <div class="w-full inset-0 md:relative md:w-1/2">
        <div class="relative hero-image">
            ...
            <img src="/frontend/images/content/image-section-1.png" alt="hero 1" class="absolute inset-0 md:relative w-full h-full object-cover object-center" />
        </div>
    </div>
</section>
<!-- END: HERO -->
        ...
        <div class="grid grid-rows-2 grid-cols-9 gap-4">
            <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                <div class="card-shadow rounded-xl">
                    <img src="/frontend/images/content/image-catalog-1.png" alt="" class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                </div>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                <div class="card-shadow rounded-xl">
                    <img src="/frontend/images/content/image-catalog-3.png" alt="" class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                </div>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                <div class="card-shadow rounded-xl">
                    <img src="/frontend/images/content/image-catalog-4.png" alt="" class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                </div>
                <div class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                    <h5 class="text-lg font-semibold">Living Room</h5>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                <div class="card-shadow rounded-xl">
                    <img src="/frontend/images/content/image-catalog-2.png" alt="" class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                </div>
                <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
        ...
        <div class="flex -mx-4 flex-row relative">
            ...
            <div class="px-4 relative card group">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                    ...
                    <img src="/frontend/images/content/image-arrived-2.png" alt="" class="w-full h-full object-cover object-center" />
                </div>
            ...
            <div class="px-4 relative card group">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                    ...
                    <img src="/frontend/images/content/image-arrived-3.png" alt="" class="w-full h-full object-cover object-center" />
                </div>
            ...
            <div class="px-4 relative card group">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                    ...
                    <img src="/frontend/images/content/image-arrived-4.png" alt="" class="w-full h-full object-cover object-center" />
                </div>
            ...
            <div class="px-4 relative card group">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                    ...
                    <img src="/frontend/images/content/image-arrived-5.png" alt="" class="w-full h-full object-cover object-center" />
                </div>
