                ...
                <div class="thumbnail">
                    <div class="px-2">
                        <div class="item selected" data-img="/frontend/images/content/showcase-1.front.jpg">
                            <img src="/frontend/images/content/showcase-1.front.jpg" alt="front" class="object-cover w-full h-full rounded-lg" />
                        </div>
                    </div>
                    <div class="px-2">
                        <div class="item" data-img="/frontend/images/content/showcase-1.back.jpg">
                            <img src="/frontend/images/content/showcase-1.back.jpg" alt="back" class="object-cover w-full h-full rounded-lg" />
                        </div>
                    </div>
                    <div class="px-2">
                        <div class="item" data-img="/frontend/images/content/showcase-1.rear.jpg">
                            <img src="/frontend/images/content/showcase-1.rear.jpg" alt="rear" class="object-cover w-full h-full rounded-lg" />
                        </div>
                    </div>
                    <div class="px-2">
                        <div class="item" data-img="/frontend/images/content/showcase-1.side.jpg">
                            <img src="/frontend/images/content/showcase-1.side.jpg" alt="side" class="object-cover w-full h-full rounded-lg" />
                        </div>
                    </div>
                    <div class="px-2">
                        <div class="item" data-img="/frontend/images/content/showcase-1.top.jpg">
                            <img src="/frontend/images/content/showcase-1.top.jpg" alt="top" class="object-cover w-full h-full rounded-lg" />
                        </div>
                    </div>
                </div>
                <div class="preview">
