                ...
                <form action="{{route('dashboard.product.update', $item->id)}}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 space-y-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" value="{{ old('name') ?? $item->name }}" name="name" placeholder="Nama Produk" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        </div>
                        <div class="w-full px-3">
                        ...
                        <div class="w-full px-3">
                            ...
                            <input type="number" value="{{ old('price') ?? $item->price }}" name="price" placeholder="Harga Produk" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        </div>
                        <div class="w-full px-3">
